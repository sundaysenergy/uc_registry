/**
 * uc_registry: Wish List / Gift Registry module for Ubercart
 *
...
uc_registry is a module that adds wish list/gift registry functionality
to Ubercart.
...
http://drupal.org/project/uc_registry
...
http://drupal.org/project/issues/uc_registry
